...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Texture2D peterGriffin;
        Texture2D brianGriffin;
        Texture2D stewieGriffin;
        ...
        protected override void LoadContent()
        {
            ...
            peterGriffin = Content.Load<Texture2D>("peter");
            brianGriffin = Content.Load<Texture2D>("brian");
            stewieGriffin = Content.Load<Texture2D>("stewie");


            // STUDENTS: set the currentSprite variable to one of your sprite variables
            currentSprite = peterGriffin;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedTime > CHANGE_DELAY_TIME)
            {
                ...
                {
                    currentSprite = brianGriffin;
                }
                else if (spriteNumber == 2)
                {
                    currentSprite = stewieGriffin;
                }
